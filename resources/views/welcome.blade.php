...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .navbar-inner { display: flex; align-items: center; justify-content: space-between; padding: 16px 24px; }
        .brand { display: flex; align-items: center; gap: 12px; font-weight: 800; font-size: 1.2rem; color: var(--purple-900); }
        .brand-mark {
        ...
        .nav-links { display: flex; align-items: center; gap: 32px; font-weight: 600; font-size: 0.95rem; color: var(--ink-muted); }
        ...
        .btn { 
            ...
            font-weight: 700; font-size: 0.95rem; border-radius: 99px; 
            padding: 14px 28px; transition: all .25s ease; cursor: pointer; 
        ...
        .btn-outline { 
            border-color: rgba(109, 40, 217, 0.25); color: var(--purple-700); 
        ...
        .hero h1 { font-size: clamp(2.2rem, 3.8vw, 3.4rem); font-weight: 800; line-height: 1.2; letter-spacing: -0.02em; margin: 0 0 20px; color: var(--purple-900); }
        .hero h1 .accent { 
            background: var(--gradient-primary);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        }
        .hero p.lead { font-size: 1.1rem; color: var(--ink-muted); max-width: 520px; margin: 0 0 36px; font-weight: 400; }
        .hero-cta { display: flex; gap: 16px; flex-wrap: wrap; margin-bottom: 32px; }
        .hero-note { display: flex; align-items: center; gap: 10px; font-size: 0.85rem; color: var(--ink-muted); font-weight: 500; }

        .hero-illustration { position: relative; }
        .hero-illustration svg { filter: drop-shadow(0 20px 30px rgba(109, 40, 217, 0.15)); }

        /* ---------- Trust strip ---------- */
        .trust { padding: 40px 0; text-align: center; }
        .trust p { font-size: 0.8rem; letter-spacing: 0.08em; text-transform: uppercase; color: var(--ink-muted); font-weight: 700; margin-bottom: 20px; }
        .trust-items { display: flex; justify-content: center; gap: 48px; flex-wrap: wrap; color: var(--purple-900); font-weight: 700; font-size: 1.1rem; opacity: 0.7; }
        ...
        .section-head h2 { font-size: clamp(1.8rem, 2.8vw, 2.2rem); font-weight: 800; margin: 0 0 16px; color: var(--purple-900); letter-spacing: -0.01em; }
        .section-head p { color: var(--ink-muted); margin: 0; font-size: 1.05rem; }
        ...
        .feature-icon svg { stroke: var(--white); }
        .feature-card h3 { font-size: 1.1rem; font-weight: 700; margin: 0 0 10px; color: var(--purple-900); }
        .feature-card p { font-size: 0.92rem; color: var(--ink-muted); margin: 0; line-height: 1.6; }

        /* ---------- How it works ---------- */
        .how { background: var(--white); border-radius: 36px; margin: 40px 0; box-shadow: var(--shadow-sm); }
        ...
        .how-step h3 { font-size: 1.1rem; font-weight: 700; margin: 0 0 10px; color: var(--purple-900); }
        .how-step p { font-size: 0.92rem; color: var(--ink-muted); margin: 0; }
        ...
        .cta-banner h2 { font-size: 1.8rem; font-weight: 800; margin: 0 0 12px; }
        .cta-banner p { color: rgba(255,255,255,0.85); margin: 0; max-width: 480px; font-size: 1.05rem; }
        ...
        /* ---------- Footer ---------- */
        footer { background: var(--purple-900); color: rgba(255,255,255,0.7); padding: 48px 0 32px; }
    ...
    <div class="container navbar-inner">
        <a href="/" class="brand">
            <span class="brand-mark">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </span>
            SKM Digital
        </a>
        <div class="nav-links">
...
<header class="hero">
    <div class="container hero-grid">
        <div class="hero-text">
            ...
            <h1>Survei kepuasan masyarakat <span class="accent">Dinas Kesehatan</span> Kab. Purworejo</h1>
            <p class="lead">
            ...
            <div class="hero-note">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#6D28D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
        ...
        <div class="hero-illustration">
            ...
            <svg viewBox="0 0 520 480" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ilustrasi survei kepuasan masyarakat">
                <defs>
...
<div class="trust">
    <div class="container">
        ...
        <div class="trust-items">
            <span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" stroke="#6D28D9" stroke-width="2" stroke-linecap="round"/></svg>
                Dinkesda Purworejo
            </span>
            <span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" stroke="#6D28D9" stroke-width="2" stroke-linecap="round"/></svg>
                Puskesmas
            </span>
            <span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" stroke="#6D28D9" stroke-width="2" stroke-linecap="round"/></svg>
                RSUD / RSU
            </span>
        </div>
    </div>
        ...
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 4v1m6 11h2m-6 0h-2v4m0-6v-3m6 0.343V11a6 6 0 10-12 0v.343m12 0A5.98 5.98 0 0012 9a5.98 5.98 0 00-6 2.343" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feature-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
...
<footer>
    <div class="container footer-inner">
        ...
        <small>&copy; {{ date('Y') }} Sistem Survei Kepuasan Masyarakat &middot; Dinkesda Purworejo</small>
    </div>
</footer>
